  ...
  group(
      'getLastWeatherInfo',
          () {
            ...
            final tWeatherInfoModel = WeatherInfoModel.fromJson(jsonDecode(fixture('weather_cached.json')));

            test(
                'should return WeatherInfoModel from SharedPreferences when there is one in the cache',
                    () async {
                      //arrange
                      when(() => mockSharedPreferences.getString(any())).thenReturn(fixture('weather_cached.json'));
                      //act
        ...
        test(
            'should call SharedPreference to cache the data',
                () async {
                  ...
                  verify(() => mockSharedPreferences.setString(CACHED_WEATHER_INFO, expectedJsonString)).called(1);
